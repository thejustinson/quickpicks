const TopGameItem = () => {
    console.log(process.env.NEXT_PUBLIC_FOOTBALL_DATA_API_KEY)
    return (
      <div className="bg-secondary-background duration-200 hover:border-primary-accent cursor-pointer p-2 sm:p-3 rounded-lg border border-neutral-700">
        ...
        <div className="grid grid-cols-3 gap-2 sm:gap-3 mt-2 sm:mt-3 text-xs sm:text-sm">
          <button className="border border-neutral-700 py-1 sm:py-2 px-2 sm:px-3 rounded hover:border-primary-accent duration-200 active:scale-90 hover:scale-105 sm:hover:scale-110">Home</button>
          <button className="border border-neutral-700 py-1 sm:py-2 px-2 sm:px-3 rounded hover:border-primary-accent duration-200 active:scale-90 hover:scale-105 sm:hover:scale-110">Draw</button>
          <button className="border border-neutral-700 py-1 sm:py-2 px-2 sm:px-3 rounded hover:border-primary-accent duration-200 active:scale-90 hover:scale-105 sm:hover:scale-110">Away</button>
        </div>
      </div>
    );
  };
